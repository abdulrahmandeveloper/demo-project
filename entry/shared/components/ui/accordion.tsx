...
import { cn } from "entry/shared/utils/utils";
...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <ChevronDownIcon className="text-muted-foreground pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200 cursor-pointer" />
      </AccordionPrimitive.Trigger>
